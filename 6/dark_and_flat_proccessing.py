...
# Function to get blue data from FITS files
...
# Function to process master dark
...
# Function to process master flat
...
# Function to process gain table
...
# Process each folder and save master dark images
